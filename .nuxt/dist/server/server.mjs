...
const _routes = [
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-CK2gIzuZ.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DYf09NHL.js")
  },
  {
    name: "product",
    path: "/product",
    component: () => import("./_nuxt/product-BACL6kwL.js")
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-Ds0qxkiw.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-OBeW0w66.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Bp5diZnT.js"));
