import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrRenderStyle, ssrRenderClass, ssrInterpolate, ssrRenderList } from 'file:///Users/macos/working/duanyu/papa/node_modules/vue/server-renderer/index.mjs';
import { mergeProps, useSSRContext } from 'file:///Users/macos/working/duanyu/papa/node_modules/vue/index.mjs';
import { _ as _export_sfc } from './server.mjs';
import { _ as _imports_0 } from './product-D9ZsmCWR.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-bb281c83><div class="${ssrRenderClass([{ open: $data.open }, "selected"])}" data-v-bb281c83>${ssrInterpolate($data.selected)}</div><div class="${ssrRenderClass([{ selectHide: !$data.open }, "items"])}" data-v-bb281c83><!--[-->`);
  ssrRenderList($props.options, (option, i) => {
    _push(`<div data-v-bb281c83>${ssrInterpolate(option)}</div>`);
  });
  _push(`<!--]--></div></div>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-bb281c83"]]);
const _sfc_main$1 = {};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="form-floating"><textarea class="form-control bg-transparent" placeholder="Leave a comment here" id="floatingTextarea2" style="${ssrRenderStyle({ "height": "100px" })}"></textarea><label for="floatingTextarea2">Message</label></div><div class="text-center text-md-start"><button type="submit" class="btn contact-form__btn">SEND</button></div></form></div></div><div class="col-12 col-md-6"><div class="position-relative d-none d-md-block"><img class="mw-100"${ssrRenderAttr("src", _imports_0)} alt="" srcset=""></div></div>`);
...
//# sourceMappingURL=contact-CiUjx3GK.mjs.map
